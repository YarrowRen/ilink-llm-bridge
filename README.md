...
- [@tencent-weixin/openclaw-weixin](https://www.npmjs.com/package/@tencent-weixin/openclaw-weixin) — 腾讯官方 openclaw 微信渠道插件，本项目 iLink API 实现的主要参考来源
- [@tencent-weixin/openclaw-weixin-cli](https://www.npmjs.com/package/@tencent-weixin/openclaw-weixin-cli) — 配套 CLI 工具
- [hao-ji-xing/openclaw-weixin](https://github.com/hao-ji-xing/openclaw-weixin) — 社区逆向解析的腾讯 iLink 协议说明
